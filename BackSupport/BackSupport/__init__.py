...
from .views_controller import api_data_op_cart
from .views_controller import api_data_op_machine_advice
...
def create_app():
    ...
    app.register_blueprint(api_data_op_cart.api_data_op_cart)
    app.register_blueprint(api_data_op_machine_advice.api_data_op_machine_advice)
